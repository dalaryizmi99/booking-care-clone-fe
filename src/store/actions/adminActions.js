...
import { getAllCodeService, createNewUserService, getAllUsers, deleteUserService, updateUserDataService, getTopDoctorHomeService, getAllDoctors, saveDetailDoctorService } from '../../services/userService';
...
export const getRequiredDoctorInfor = () => {
    return async (dispatch, getState) => {
        try {
            ...
            dispatch(fetchRequiredDoctorInforFailed());
            console.log('getRequiredDoctorInforStart err', e)
        }
    }
}

        ...
        return (
            <div className='doctor-extra-infor-container'>
                <div className='content-up'>
                    <div className='text-address'><FormattedMessage id='patient.extra-infor-doctor.clinic-address' /></div>
                ...
                <div className='content-down'>
                    {isShowDetailInfor === false ?
                        <div className='short-infor'>
                            ...
                            <span className='show-hidden-infor' onClick={() => this.showHiddenDetailInfor(true)}>
                                <FormattedMessage id='patient.extra-infor-doctor.show-button' />
                            </span>
                        </div>
                        :
                        <>
                            ...
                            <div className='payment'>
                                <div><FormattedMessage id='patient.extra-infor-doctor.payment-method' />
                            ...
                            <div className='hide-price'>
                                <span onClick={() => this.showHiddenDetailInfor(false)}>
                                    <FormattedMessage id='patient.extra-infor-doctor.hidden-button' />
                                </span>
                            </div>
                        </>
                    }

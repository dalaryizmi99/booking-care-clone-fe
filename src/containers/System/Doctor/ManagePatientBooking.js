...
import { getListPatientBookingForDoctor, postSendRemedy } from '../../../services/userService';
...
class ManagePatientBooking extends Component {
    ...
    getDataPatient = async () => {
        ...
        let res = await getListPatientBookingForDoctor({
            doctorId: user.id,
            date: formatedDate
        })
            ...
            <>
                ...
                >
                    <div className='manage-patient-booking-container'>
                        <div className='manage-patient-booking-title'>
                            <FormattedMessage id='Quan ly lich trinh kham benh' />
                        </div>
                        <div className='manage-patient-body row'>
                            <div className='col-4 form-group'>
                                <label><FormattedMessage id='Chon ngay kham' /></label>
                                <DatePicker

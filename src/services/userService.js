...
const getListPatientBookingForDoctor = (data) => {
    return axios.get(`/api/get-list-booking-patient-for-doctor?doctorId=${data.doctorId}&date=${data.date}`)
}
...
export {
    ...
    getListPatientBookingForDoctor,
    postSendRemedy,
}
